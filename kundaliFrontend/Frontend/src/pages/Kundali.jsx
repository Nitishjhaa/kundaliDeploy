...
const KundaliForm = () => {
  ...
  const { fetchKundali, loading, error } = useApi();
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await fetchKundali(formData);
    await new Promise((resolve) => setTimeout(resolve, 2000));

    navigate("/kundali-Info", { state: { data: result } });
  };

  return (
    <>
      <div className="relative max-md:py-10" style={{backgroundImage:"url('Images/earth-2.png')",backgroundPosition:"top",backgroundSize:'50vw 100vh' }}>
